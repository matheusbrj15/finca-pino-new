...
export function FinalCta({ checkoutUrl, formattedPrice }: FinalCtaProps) {
  return (
    <section className="bg-[#f2f2f2] px-4 py-12 sm:px-6 sm:py-16">
      <div className="mx-auto grid w-full max-w-[980px] overflow-hidden rounded-[30px] bg-[#141414] shadow-[0_30px_80px_rgba(0,40,112,0.18)] lg:grid-cols-[1fr_0.72fr]">
